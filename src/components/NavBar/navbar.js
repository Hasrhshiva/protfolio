...
import menu from '../../assets/drop-down-menu.png';
const Navbar = () => {
  ...
  return (
    <nav className='navbar'>
        ...
        <div className='desktopMenu'>
            ...
            <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-50} duration={500}  className="desktopMenuListItem">Protfolio</Link>
        </div>
        ...
        <div className='navMenu' style={{display: showMenu? 'flex' : 'none'}}>
            ...
            <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-50} duration={500}  className="listItem" onClick={()=>setShowMenu(false)}>Protfolio</Link>
